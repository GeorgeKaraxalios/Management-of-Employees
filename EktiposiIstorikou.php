<?php
    ...
    echo "Print History!<br>";
    include './connector.php';
    $Connector = new Connector();

    $result = $Connector->prepare("SELECT * FROM history");
    ...
    $html_body = $html_body."<tr>"
                                ."<td align='center'><h4>Όνομα</h3></t4>"
                                ."<td align='center'><h4>Επώνυμο</h3></t4>"
                                ."<td align='center'><h4>Δουλειά που εκτελέστεικε</h4></td>"
                                ."<td align='center'><h4>Περιγραφή δουλειάς</h4></td>"
                            ."</tr>";
    while ($row = $result->fetch())
    {
        $html_body = $html_body."<tr>"
                                    ."<td align='center'>".$row['NameOfLogin']."</td>"
                                    ."<td align='center'>".$row['SurnameOfLogin']."</td>"
                                    ."<td align='center'>".$row['WhatWorkDoesUser']."</td>"
                                    ."<td align='center'>".$row['Description']."</td>"
                                ."</tr>";
    }
    $html_body = $html_body."</table>"."</body>"."</html>";
    ...
    $description = "Ο/Η χρήστης (ον) ".$_SESSION['NameOfLogin']." (επ) ".$_SESSION['SurnameOfLogin']." εκτέλεσε την λειτουργία "
                  ."".$_SESSION['AntistoixoKoumpi'].". Η ".$_SESSION['AntistoixoKoumpi']." πραγματοποιήθηκε στις "
    ...
    header("content-disposition: attachment;filename=LALA.doc");
?>
